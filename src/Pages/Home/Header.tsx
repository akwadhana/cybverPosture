    ...
    <div className="text-center relative">
      ...
      >
        ...
        <div className="flex flex-col items-center">
          <h1 className="lg:text-[248px] text-[72px] font-bold text-center transition-opacity duration-1000">
            {showFirst ? "Protected" : "Secured․"}
          </h1>
        ...
        <div className="flex mt-5 space-x-4">
          ...
          <button className="relative p-[2px] rounded-full bg-gradient-to-r from-[#460389] to-[#09C6DE] hover:from-[#09C6DE] hover:to-[#460389] transition-all duration-300">
